...
combination_dict_list.append({'scenario':'Reference', 'transport_type':'passenger', 'medium':'road', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in energy use (Ref)', 'extra_identifier':'PASSENGER_REF_MODE_DRIVE_ROAD', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'passenger', 'medium':'road', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in energy use (CN)', 'extra_identifier':'PASSENGER_CN_MODE_DRIVE_ROAD', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Reference', 'transport_type':'freight', 'medium':'road', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in energy use (Ref)', 'extra_identifier':'FREIGHT_REF_MODE_DRIVE_ROAD', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'freight', 'medium':'road', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in energy use (CN)', 'extra_identifier':'FREIGHT_CN_MODE_DRIVE_ROAD', 'emissions_divisia':False})
#for medium is everything
combination_dict_list.append({'scenario':'Reference', 'transport_type':'passenger', 'medium':'everything', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in energy use (Ref)', 'extra_identifier':'PASSENGER_REF_MODE_DRIVE', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'passenger', 'medium':'everything', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in energy use (CN)', 'extra_identifier':'PASSENGER_CN_MODE_DRIVE', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Reference', 'transport_type':'freight', 'medium':'everything', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in energy use (Ref)', 'extra_identifier':'FREIGHT_REF_MODE_DRIVE', 'emissions_divisia':False})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'freight', 'medium':'everything', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in energy use (CN)', 'extra_identifier':'FREIGHT_CN_MODE_DRIVE', 'emissions_divisia':False})
...
combination_dict_list.append({'scenario':'Reference', 'transport_type':'freight', 'medium':'road', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in emissions (Ref)', 'extra_identifier':'FREIGHT_REF_MODE_DRIVE_ROAD_EMISSIONS', 'emissions_divisia':True})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'freight', 'medium':'road', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in emissions (CN)', 'extra_identifier':'FREIGHT_CN_MODE_DRIVE_ROAD_EMISSIONS', 'emissions_divisia':True})
#for medium is everything
combination_dict_list.append({'scenario':'Reference', 'transport_type':'passenger', 'medium':'everything', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in emissions (Ref)', 'extra_identifier':'PASSENGER_REF_MODE_DRIVE_EMISSIONS', 'emissions_divisia':True})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'passenger', 'medium':'everything', 'activity_variable':'passenger_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road passenger - Drivers of changes in emissions (CN)', 'extra_identifier':'PASSENGER_CN_MODE_DRIVE_EMISSIONS', 'emissions_divisia':True})
combination_dict_list.append({'scenario':'Reference', 'transport_type':'freight', 'medium':'everything', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in emissions (Ref)', 'extra_identifier':'FREIGHT_REF_MODE_DRIVE_EMISSIONS', 'emissions_divisia':True})
combination_dict_list.append({'scenario':'Carbon Neutral', 'transport_type':'freight', 'medium':'everything', 'activity_variable':'freight_tonne_km', 'structure_variables_list':['Vehicle Type', 'Drive'], 'graph_title':'Road freight - Drivers of changes in emissions (CN)', 'extra_identifier':'FREIGHT_CN_MODE_DRIVE_EMISSIONS', 'emissions_divisia':True})
...
for combination_dict in combination_dict_list:
    ...
    #run LMDI
    results = main_function.run_divisia(data_title, extra_identifier, activity_data, energy_data, structure_variables_list, activity_variable, emissions_variable = 'Emissions', energy_variable = energy_variable, emissions_divisia = emissions_divisia, emissions_data=emissions_data, time_variable=time_variable)

    #plot LMDI
    plot_output.plot_additive_waterfall(data_title, extra_identifier, structure_variables_list=structure_variables_list,activity_variable=activity_variable,energy_variable='Energy', emissions_variable='Emissions',emissions_divisia=emissions_divisia, time_variable='Year', graph_title=graph_title, residual_variable1='Energy intensity', residual_variable2='Emissions intensity', font_size=font_size, y_axis_min_percent_decrease=y_axis_min_percent_decrease,AUTO_OPEN=AUTO_OPEN)
