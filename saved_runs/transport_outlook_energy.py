...
gdp_data = pd.read_excel('input_data/{}.xlsx'.format(data_title), sheet_name='cn_p_km')
...
gdp_data = pd.read_excel('input_data/{}.xlsx'.format(data_title), sheet_name='cn_freight_tonne_km')
...
gdp_data = pd.read_excel('input_data/{}.xlsx'.format(data_title), sheet_name='ref_freight_tonne_km')
