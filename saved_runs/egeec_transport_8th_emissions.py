...
if MODE:
    ...
    data_title = 'outlook-transport-divisia'
    extra_identifier = 'PASSENGER_REF_MODE_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_ref_passenger_mode_wide.csv')
    ...
    graph_title = 'Road passenger - Drivers of changes in emissions (Ref)'
    ...
    ############################################################################
    data_title = 'outlook-transport-divisia'
    extra_identifier = 'PASSENGER_CN_MODE_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_cn_passenger_mode_wide.csv')
    ...
    #plot_multiplicative(data_title, extra_identifier, emissions_divisia, time_variable='Year', structure_variable=structure_variable, graph_title = graph_title, residual_variable1 = residual_variable1)
    plot_additive_EGEEC_transport(data_title, extra_identifier, emissions_divisia, time_variable='Year', structure_variable=structure_variable, graph_title = graph_title, residual_variable1 = residual_variable1)
    
    #EMISSIONS
    emissions_divisia = True
    graph_title = 'Road passenger - Drivers of changes in emissions (CN)'
    ...
    ############################################################################
    data_title = 'outlook-transport-divisia'
    extra_identifier = 'FREIGHT_REF_MODE_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_cn_freight_mode_wide.csv')
    ...
    #EMISSIONS
    emissions_divisia = True
    graph_title = 'Road freight - Drivers of changes in emissions (Ref)'
    ...
    ############################################################################
    data_title = 'outlook-transport-divisia'
    extra_identifier = 'FREIGHT_CN_MODE_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_ref_freight_mode_wide.csv')
...
if DRIVE:
    ...
    ###########################################################################
    #import data from excel using a preset name for the data, which is also used for creating graph titles and genreally identifying outputs/inputs related to this dataset specifically
    extra_identifier = 'FREIGHT_CN_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_cn_freight_drive_wide.csv')
    ...
    emissions_data = emissions_data.rename(columns={'Drive': structure_variable})
    ...
    #EMISSIONS
    emissions_divisia = True
    graph_title = 'Road freight - Drivers of changes in emissions (CN)'
    ...
    extra_identifier = 'FREIGHT_REF_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_ref_freight_drive_wide.csv')
    ...
    #import data from excel using a preset name for the data, which is also used for creating graph titles and genreally identifying outputs/inputs related to this dataset specifically
    extra_identifier = 'PASSENGER_REF_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_ref_passenger_drive_wide.csv')
    ...
    extra_identifier = 'PASSENGER_CN_CO2'#use this if you need the program to insert an extra identifier in things like filenames and plot titles
    ...
    emissions_data = pd.read_csv('input_data/tranport_8th/transport_8th_emissions_road_cn_passenger_drive_wide.csv')
